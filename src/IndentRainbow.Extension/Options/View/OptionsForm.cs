...
namespace IndentRainbow.Extension.Options.View
{
	public partial class OptionsForm : UserControl
	{
		...
		{
#pragma warning disable CA1031 // 不捕获一般异常类型
            try
            {
				System.Diagnostics.Process.Start("https://github.com/chingucoding/IndentRainbow");
			}
			catch (Exception) { }
#pragma warning restore CA1031 // 不捕获一般异常类型
        }

        private void restartDisclaimer_Click(object sender, EventArgs e)
        {

        }

        private void optionsPropertyGrid_Click(object sender, EventArgs e)
        {
